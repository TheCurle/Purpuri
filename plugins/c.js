...
let compileableExtensions = ["c", "cpp", "s"];
...
module.exports = {
    ...
    extensionCPP: function(buildscript) {
        extensionC(buildscript);
        defaultCompiler = "g++";
    },
    ...
    stepCompile: function(...params) {
        ...
        for(var param of params) {
            ...
            if(param.startsWith("-")) {
                ...
                if(compileableExtensions.includes(param.substr(param.lastIndexOf(".") + 1))) {
                    let compilerCommand =
                        defaultCompiler + 
                        " -c " + param +
                        " -o " + binPath + ".o "
